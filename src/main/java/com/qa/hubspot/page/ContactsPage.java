...
import io.qameta.allure.Step;
	...
	By createContactButton = By.xpath("(//button[@type='button']//span[text()='Create contact'])[1]");
	By createContactFormButton = By.xpath("(//button[@type='button']//span[text()='Create contact'])[2]");
	
	By email = By.xpath("//input[@data-field='email']");
	By firstName = By.xpath("//input[@data-field='firstname']");
	By lastName = By.xpath("//input[@data-field='lastname']");
	By jobTitle = By.xpath("//input[@data-field='jobtitle']");
	By contact = By.xpath("//i18n-string[@data-key='genericTypes.capitalized.CONTACT']");
	...
	public String getContactsPageTitle(){
		...
		elementUtil.waitForTitlePresent(contact);
